...
To determine if the virtual address is in segment 0 or 1:
Take decimal value, convert to binary value. Should be 10 digits long.
Topbit == leftmost bit. If topbit == 1, segment 1. If topbit == 0, segment 0.
